...
This web app: The app allows a user to create a team of players of their choice and give them any ratings based on the position each players play. Users can also view, delete, and update their created players.
